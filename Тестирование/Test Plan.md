...
#### 5. Поставить на паузу
Этот вариант использования небходимо протестировать во время игрового процесса. При нажатии клавиши "Esc" пользователю должно отобразиться меню паузы, а игра должна ыть приостановлена.
